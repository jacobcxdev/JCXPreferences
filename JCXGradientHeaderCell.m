...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
    ...
    if (self) {
        ...
        _label.text = specifier.properties[@"label"] ? [specifier.properties[@"label"] stringByInterpolatingPackageInfoFromControl:[JCXPackageInfo control]] : [JCXPackageInfo control][@"Name"];
        ...
        _detailLabel.text = specifier.properties[@"subtitle"] ? [specifier.properties[@"subtitle"] stringByInterpolatingPackageInfoFromControl:[JCXPackageInfo control]] : [@"v" stringByAppendingString:[JCXPackageInfo control][@"Version"]];
